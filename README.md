...
* **The Elbow Method:** Conducted an iterative WCSS (Within-Cluster Sum of Squares) analysis to mathematically determine the optimal number of clusters ().
